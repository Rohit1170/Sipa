...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://www.sipanutrition.com/blog/vitamin-d3-k2-together",
    },
  ],
};
  ...
  return (
    <>
      ...
      <Head>
        ...
        <title>
          Why Vitamin D3 + K2 Are Important & Why They Should Be Taken Together
          | SIPA Nutrition
        </title>
        <meta
          name="description"
          content="Discover why Vitamin D3 and K2 must be taken together for optimal bone health, immunity, and heart protection. SIPA Nutrition's vegan D3+K2 sachets: lab-tested, sugar-free, India's smartest daily supplement."
        />
        <meta
          name="keywords"
          content="Vitamin D3 K2 together, Vitamin D3 benefits, Vitamin K2 MK-7 benefits, vegan Vitamin D3 India, D3 K2 supplement sachets, cholecalciferol, menaquinone MK7, bone health supplement India, immunity supplement India, SIPA Nutrition"
        />
        ...
        <link
          rel="canonical"
          href="https://www.sipanutrition.com/blog/vitamin-d3-k2-together"
        />
        ...
        <meta
          ...
          content="Two essential vitamins. One powerful synergy. Discover the science of D3+K2 and why India's first vegan sachet is the smarter way to supplement."
        />
        <meta
          property="og:url"
          content="https://www.sipanutrition.com/blog/vitamin-d3-k2-together"
        />
        <meta property="og:site_name" content="SIPA Nutrition" />
        <meta
          property="og:image"
          content="https://www.sipanutrition.com/hero.jpeg"
        />
        ...
        <meta
          name="twitter:title"
          content="Why Vitamin D3 and K2 Should Always Be Taken Together"
        />
        <meta
          name="twitter:description"
          content="The science behind the D3+K2 synergy — and India's first vegan sachet that gets it right."
        />
        <meta
          name="twitter:image"
          content="https://www.sipanutrition.com/hero.jpeg"
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,700;1,400&family=DM+Sans:wght@300;400;500;600;700&display=swap"
          rel="stylesheet"
        />
      </Head>
          ...
          <article itemScope itemType="https://schema.org/Article">
            ...
            <div className="max-w-[980px] mx-auto px-6">
              ...
              <div className="flex gap-4 justify-center text-[0.8rem] mt-8">
                {[
                  {
                    href: "https://twitter.com/intent/tweet?url=https://www.sipanutrition.com/blog/vitamin-d3-k2-together&text=Why Vitamin D3 + K2 must be taken together",
                    label: "🐦 Share",
                  },
                  {
                    href: "https://www.linkedin.com/sharing/share-offsite/?url=https://www.sipanutrition.com/blog/vitamin-d3-k2-together",
                    label: "💼 LinkedIn",
                  },
                  {
                    href: "https://wa.me/?text=Why D3+K2 together: https://www.sipanutrition.com/blog/vitamin-d3-k2-together",
                    label: "📱 WhatsApp",
                  },
                ].map((s) => (
                  <a
