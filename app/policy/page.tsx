      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 pb-24 pt-28">
        ...
        <section className="mb-16">
          ...
          <div className="border border-neutral-300 rounded-xl overflow-hidden mb-6">
            {/* header */}
            <div className="grid grid-cols-3 bg-neutral-900 px-6 py-3">
            ...
            {[
              ...
              <div key={i}
                className={`grid grid-cols-3 items-center px-6 py-4 border-t border-neutral-200 ${i % 2 !== 0 ? "bg-neutral-50/60" : "bg-[#f7f4ef]"}`}>
