  ...
  return (
    <section ref={ref} className="py-0 lg:py-8 bg-[#f7f4ef] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 w-full">
        ...
        {/* Header */}
        <div
          className={`mb-4 lg:mb-8 transition-all duration-700 ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-300">
          {steps.map((s, i) => (
            <div
              key={i}
              className={`bg-[#f7f4ef] p-6 lg:p-10 flex flex-col justify-between min-h-45 lg:min-h-70 transition-all duration-700 ${
