...
const features = [
  {
    ...
    description:
      "Sourced from lichen via VitaShine® — the purest plant-based D3 available.",
    accent: "#c2410c",
  },
  {
    number: "02",
    ...
    description:
      "Vitamin K2 works synergistically to maximise calcium uptake and utilisation.",
    accent: "#166534",
  },
  {
    number: "03",
    ...
    description:
      "A daily maintenance dose — clinically safe without requiring a prescription.",
    accent: "#c2410c",
  },
  {
    number: "04",
    ...
    description:
      "No added sugar. No artificial additives. Just clean, natural taste.",
    accent: "#166534",
  },
  {
    number: "05",
    ...
    title: "Easy to Carry",
    description:
      "Slim 1g sachets designed to fit seamlessly into any daily routine.",
    accent: "#c2410c",
  },
  {
    number: "06",
    ...
    description:
      "Formulated for sustained daily maintenance — consistent results over time.",
    accent: "#166534",
  },
];
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <p
              ...
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              A complete nutritional solution built for daily wellness — every
              ingredient chosen with purpose and precision.
            </p>
          </div>
        </div>

        {/* Feature Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-neutral-300">
          {features.map((f, i) => (
            <div
              key={i}
              className={` bg-[#f7f4ef] p-10 flex flex-col min-h-[260px]
        border-neutral-300
        ...
        ${i < 3 ? "border-b" : ""} ${
          inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            ...
            >
              ...
              <div className="h-px bg-neutral-200 mb-5 mt-2" />
              <div>
                <p
